...
import styles from './UpcomingDaysWeatherItem.module.css';

const imgUrlBase = 'https://www.metaweather.com/static/';

const UpcomingDaysWeatherItem = ({ weekday, temperature, imgUrl }) => (
...
// UpcomingDaysWeatherItem.propTypes = {
//     weekday: PropTypes.string.isRequired,
//     temperature: PropTypes.string.isRequired,
//     imgUrl: PropTypes.string.isRequired,
// };

export default UpcomingDaysWeatherItem;